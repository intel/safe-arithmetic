...
TEST_F(safe_invoke_test, fail_with_an_input_var) {
    EXPECT_CALL(my_mock_function, two_safe_vars(_, _)).Times(0);
    bool fail = false;
    safe::function<void>(two_safe_vars, [&](){fail = true;})(11, 9_s32);
    EXPECT_TRUE(fail);
}
