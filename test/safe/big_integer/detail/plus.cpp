...
RC_GTEST_PROP(plus, asymmetric_is_commutative,
...
RC_GTEST_PROP(plus, is_associative,
...
RC_GTEST_PROP(plus, is_plus, (int64_t a, int64_t b)) {
    RC_PRE(addition_will_not_overflow(a, b));
    storage<64> actual{};
    plus(actual, make_storage(a), make_storage(b));
