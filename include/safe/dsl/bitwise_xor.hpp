...
struct bitwise_xor : public detail::binary_op {};

template <detail::Primitive LhsT, detail::Primitive RhsT>
struct bitwise_xor<LhsT, RhsT> : public detail::binary_op {
...
[[nodiscard]] constexpr auto operator^(LhsT, RhsT) -> bitwise_xor<LhsT, RhsT> {
    return {};
}
} // namespace safe::dsl