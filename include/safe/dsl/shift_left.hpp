...
struct shift_left<ival_t<lhs_min, lhs_max>, ival_t<rhs_min, rhs_max>>
...
struct shift_left<mask_t<lhs_var_bits, lhs_const_bits>,
                  ival_t<rhs_min, rhs_max>> : public detail::binary_op {
    using type = mask_t<lhs_var_bits << rhs_max, lhs_const_bits << rhs_max>;
};
...
struct shift_left<mask_t<lhs_var_bits, lhs_const_bits>,
    ...
    using type = bitwise_or<shift_left<lhs_mask, ival_t<rhs_min, rhs_max - 1>>,
