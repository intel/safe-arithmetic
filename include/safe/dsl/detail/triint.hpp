...
namespace safe::dsl {
    ...
    public:
        ...
        constexpr triint(
            ...
            : var_bits_{var_bits}
            , const_bits_{const_bits & ~var_bits}
        {}

        [[nodiscard]] constexpr T var_bits() const {
            return var_bits_;
        }

        [[nodiscard]] constexpr T const_bits() const {
            return const_bits_;
        }
    };
    ...
    template<
        ...
        typename CarryInT,
        typename CarryOutT>
    [[nodiscard]] constexpr auto full_adder(
        triint<LhsT> lhs,
        triint<RhsT> rhs,
